...
const (
	...
	SampleServiceName = "SampleService"
)

// SampleServiceClient is a client for the SampleService service.
type SampleServiceClient interface {
	Sample(context.Context, *connect_go.Request[sample.SampleRequest]) (*connect_go.Response[sample.SampleResponse], error)
}

// NewSampleServiceClient constructs a client for the SampleService service. By default, it uses the
...
// Sample calls SampleService.Sample.
...
// SampleServiceHandler is an implementation of the SampleService service.
...
func NewSampleServiceHandler(svc SampleServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/.SampleService/Sample", connect_go.NewUnaryHandler(
		"/.SampleService/Sample",
		svc.Sample,
		opts...,
	))
	return "/.SampleService/", mux
}
...
func (UnimplementedSampleServiceHandler) Sample(context.Context, *connect_go.Request[sample.SampleRequest]) (*connect_go.Response[sample.SampleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("SampleService.Sample is not implemented"))
}
